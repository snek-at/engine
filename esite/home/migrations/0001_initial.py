    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hero_button_text', models.CharField(blank=True, max_length=55, null=True)),
                ('articles_title', models.CharField(blank=True, max_length=150, null=True)),
                ('articles_linktext', models.CharField(blank=True, max_length=80, null=True)),
                ('featured_pages_title', models.CharField(blank=True, max_length=150, null=True)),
                ...
                ('articles_link', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailcore.Page')),
                ('featured_image', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='images.SNEKImage')),
                ('hero_button_link', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailcore.Page')),
                ...
                ('news_link', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailcore.Page')),
                ('pages_link', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailcore.Page')),
